...
class SimToSimCfg:
    class path:
        ...
        model_path = '/home/woan/workspace/TienKung-Lab/logs/g1qiewalk/2026-04-30_17-36-02/exported/policy.pt'

    class sim:
        sim_duration = 10000.0
        control_mode = "motor"  # "position" or "motor"
        action_dim = 23
        state_dim = 13 + 3 * action_dim
        dt = 0.005
        decimation = 4
        gait_cycle = 0.65
        his_lens = 10
        obs_slices = {
            ...
            "gait": (9+action_dim*3, 13+action_dim*3)
        }
